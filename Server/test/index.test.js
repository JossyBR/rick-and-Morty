...
describe("Test de RUTAS", () => {
  ...
  describe("GET /rickandmorty/login", () => {
    it("Ruta de login retorna access true", async () => {
      const response = (
        await agent.get(
          "/rickandmorty/login?email=jossybr94@gmail.com&password=1jossybr"
        )
      ).body;
    ...
    it("Ruta de login retorna access true", async () => {
      const response = (
        await agent.get("/rickandmorty/login?email=jossybr94com&password=br")
      ).body;
  ...
  describe("DELETE /rickandmorty/fav/:id", () => {
    ...
    it("Se elimina un personaje de favorios exitosamente", async () => {
